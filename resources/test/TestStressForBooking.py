...
def run_test(url, num_requests, user_id_start, request_data):
    """
    多线程发起请求
    :param url: 请求地址
    :param num_requests: 线程数量，相当于请求数量
    :param user_id_start: 模拟token中携带的user ID
    :param request_data: 请求体
    """
    # 创建线程池
    threads = []
...
if __name__ == "__main__":
    ...
    # 运行压力测试
    run_test(target_url, num_requests, user_id_start, request_data)
